...
body:not(.modal-open){ padding-right: 0px !important; }
      ...
      <div class="content-wrapper">        
        ...
        <section class="content">
          <center><label style="font-size:40px" id="idtitulo"> CONSULTA DE COMPRAS POR FECHA </center></label> 
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/comprasfechab.js"></script>
<?php
  }
  ob_end_flush();
?>