...
function agregarDetalle(idarticulo,articulo,precio_venta,stock)
  {
    ...
    if (idarticulo!="" )
    {
    	...
    	'<td><input type="number"  name="precio_venta[]" id="precio_venta[]" value="'+precio_venta+'" readonly></td>'+
    	'<td><input type="number" name="descuento[]" value="'+descuento+'" ></td>'+
    	'<td><span name="subtotal" id="subtotal'+cont+'">'+subtotal+'</span></td>'+
    	'<td><button type="button" onclick="modificarSubototales()" class="btn btn-info"><i class="fa fa-refresh"></i></button></td>'+
    	'<td><input type="text" readonly="readonly"  name="stock[]" id="stock[]" value="'+stock+'"></td>'+
    	'</tr>';
    	cont++;
    	detalles=detalles+1;
