                  ...
                  <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="stock" id="stock" required placeholder="N°de articulos " max="9999999999">
                          </div>
...
<script type="text/javascript" src="scripts/articulob.js"></script>
<?php
