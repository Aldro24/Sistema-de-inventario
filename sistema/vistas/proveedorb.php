...
body:not(.modal-open){ padding-right: 0px !important; }
      ...
      <div class="content-wrapper">        
        ...
        <section class="content">
          <center><label style="font-size:40px" id="idtitulo" align="left" > PROVEEDOR  </label> </center>
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <h1 class="box-title"> <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar proveedor</button></h1>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/proveedorb.js"></script>
<?php
  }
  ob_end_flush();
?>