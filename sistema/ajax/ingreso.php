...
switch ($_GET["op"]){
  ...
  case 'listarDetalle':
    ...
    while ($reg = $rspta->fetch_object())
        {
          echo '<tr class="filas"><td></td><td>'.$reg->nombre.'</td><td>'.$reg->cantidad_articulos.'</td><td>'.$reg->precio_compra.'</td><td>'.$reg->precio_venta.'</td><td>'.$reg->precio_compra*$reg->cantidad_articulos.'</td></tr>';
          $total=$total+($reg->precio_compra*$reg->cantidad_articulos);
        }
    echo '<tfoot>
                                    <th>TOTAL</th>
                                    <th></th>
