...
switch ($_GET["op"]){
    ...
    case 'listar':
        ...
        while ($reg=$rspta->fetch_object()){
            $data[]=array(
                "0"=>($reg->condicion)?'<button class="btn btn-warning" onclick="mostrar('.$reg->idusuario.')"><i class="fa fa-pencil"></i></button></abbr>'.
...
//Almacenar los permisos asignados al usuario wn el array
...
case 'verificar':
    ...
    if(isset($fetch))
    {
        ...
        //determinamos si el usuario tiene acceso
        ...
        in_array(8,$valores)?$_SESSION['Inventario']=1:$_SESSION['Inventario']=0;
